...
const validationSchema = Yup.object({
    ...
    responsive: Yup.array().min(1, "Select at least one size"),
    ...
    deliverables: Yup.array().min(1, "Select at least one deliverable"),
...
export default function UiUxDesignForm() {
    ...
    useEffect(()=>{
        let endPoint = '/api/services/bfkw0mqgezf7vsx7hmsq1t6z'
                        ...
                        <Formik
                            ...
                            onSubmit={async (values, { setSubmitting }) => {
                                ...
                                let data = {
                                    ...
                                    platforms: values.responsive,
                                    post_types: values.deliverables,
                                        ...
                                        <div className=" w-100">
                                            ...
                                            <div className={style.textListWrapper}>
                                                <Field as="select" name="purpose" id="purpose" className={style.selectInput} >
                                                    ...
                                                    <option value="Brand awareness">Website Redesign</option>
                                                    <option value="Promote a product/service">Mobile App Design (iOS/Android)</option>
                                                    <option value="Event announcement">Landing Page</option>
                                                    <option value="Engagement">Dashboard/Admin Panel</option>
                                                    <option value="Testimonials"> E-commerce Store</option>
                                                    <option value="Educational content">Portfolio Website</option>
                                                    <option value="Educational content">Blog/Content Platform</option>
                                                    <option value="Educational content">Membership Portal</option>
                                                </Field>
                                                <label className={style.selectLabel} htmlFor="purpose" >Project Purpose <span className=" text-warning">*</span></label>
                                                <ErrorMessage name="purpose" component="div" className={style.error} />
                                            </div>


                                            <div className={style.textCheckWrapper}>
                                                <label>Responsive <span className=" text-warning">*</span>
                                                    <div className={style.check} role="group">
                                                        {[
                                                            ...
                                                            <div key={item} className={style.block}>
                                                                <Field type="checkbox" name="responsive" value={item} /> {item}
                                                        ...
                                                        <ErrorMessage name="responsive" component="div" className={style.errorMs} />
                                                    </div>
                                                </label>
                                            </div>

                                            <div className={style.textCheckWrapper}>
                                                <label>Design Deliverables <span className=" text-warning">*</span>
                                                    <div className={style.check} role="group">
                                                        {[
                                                            "Wireframes",
                                                            ...
                                                            <div key={item} className={style.block}>
                                                                <Field type="checkbox" name="deliverables" value={item} /> {item}
                                                                <svg viewBox="0 0 35.6 35.6">
                                                                    <circle className={style.background} cx="17.8" cy="17.8" r="17.8"></circle>
                                                                    <circle className={style.stroke} cx="17.8" cy="17.8" r="14.37"></circle>
                                                                    <polyline className={style.check} points="11.78 18.12 15.55 22.23 25.17 12.87"></polyline>
                                                        ...
                                                        <ErrorMessage name="deliverables" component="div" className={style.errorMs} />
                                                    </div>
                                                </label>
                                            </div>
